...
def add_category_message_validator(message) -> bool:
    ...
    return _allowable_message_word_count_validator(
        list_message_words
    ) and _allowable_message_length_validator(list_message_words, 60)
...
def _allowable_message_length_validator(
    list_message_words: List[str], max_length: int
) -> bool:
    """
